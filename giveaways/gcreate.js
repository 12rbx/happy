    ...
    run: async (bot, messageOrInteraction, args, { member, guild, channel, reply }) => {
        return new Promise(async resolve => {
            ...
            const finishGiveaway = async () => {
                ...
                const giveawayMessage = require("safe-stable-stringify")(giveaway.requirements) !== `{"roles":{"cantHave":[],"mustHave":[]}}` ? Utils.variables.embeds.Embeds.GiveawayWithRequirements : Utils.variables.embeds.Embeds.Giveaway;
