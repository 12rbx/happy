...
module.exports = {
    ...
    run: async (bot, messageOrInteraction, args, { member, guild, reply, prefixUsed }) => {
        return new Promise(async resolve => {
            ...
            let command = args[1] ? Commands
                .filter(c => !['mod', 'admin', 'management', 'giveaways', 'utils', 'staff'].includes(c.type))
            ...
            if (config.Help.Type.toLowerCase() == "categorized") {
                ...
                if (category) {
                    ...
                    if (commands.length) {
                        ...
                        reply(Utils.Embed({
                            title: `${category.Emoji} ${category.DisplayNames[1]} (${lang.Global.Page} ${page}/${pages})`,
                ...
                reply(Utils.setupMessage({
                    ...
                    variables: [
                        ...Utils.userVariables(guild.me, "1013948322693791856"),
    ...
    aliases: [],
    usage: "help [command|module] [command name|module name]",
    arguments: [
        {
            name: "type",
